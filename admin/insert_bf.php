...
<?php
	...
	if(isset($_POST['insert']))
	{
		...
		$insert_p = "INSERT INTO breakfast VALUES('','$p_brands','$p_model','$p_price','$p_img','$p_desc')";
		$query = mysqli_query($con,$insert_p);
		echo "<script>alert('Product has been successfully inserted into the database.')</script>";
		echo "<script>window.open('insert_bf.php','_self')</script>";	
                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white" aria-current="page"><a href="insert_bf.php">Product Breakfast</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="container">
            	<div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h1 class="text-white mb-4">Breakfast</h1>
                        <form method="post" action="insert_bf.php" enctype="multipart/form-data">
                            <div class="row g-3">
                            	<div class="col-md-6">
